...
public class Habitante implements Comparable<Habitante>{
    ...
    public boolean equals(Object otro) {
        ...
        if(otro instanceof Habitante) {
            Habitante h = (Habitante) otro;
            return this.dni.equals(h.dni);
        }
        return false;
    }
    ...
    public int compareTo(Habitante otro) {
        // COMPLETAR
        if(!this.apellido1.equals(otro.apellido1)) {
            return this.apellido1.compareTo(otro.apellido1);
        } else if(!this.apellido2.equals(otro.apellido2)) {
            return this.apellido2.compareTo(otro.apellido2);
        } else if(!this.nombre.equals(otro.nombre)) {
